...
const AuthForm = (props) => {
  ...
  const formSubmitHandler = async (event) => {
    ...
    if (!isLoggedIn) {
      sendRequest({
        url: "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyA_d7k8l39N4GuM-CKSPYhBbhDrsJ-MQJQ",
        method: "POST",
        body: {
          email: enteredEmail,
      ...
      sendRequest(
        {
          url: "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyA_d7k8l39N4GuM-CKSPYhBbhDrsJ-MQJQ",
          method: "POST",
          body: {
            email: enteredEmail,
            password: enteredPassword,
